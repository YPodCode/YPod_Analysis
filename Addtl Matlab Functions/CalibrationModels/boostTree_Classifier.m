function func = boostTree_Classifier(a)
...
% Auto-generated by MATLAB on 06-Aug-2018 15:18:16
%% Uses the settings and code from the Classification learner app on a Linear Discriminant model
switch a
    case 1; func = @boosTreeGen;
    case 2; func = @boosTreeApply;
    case 3; func = @boosTreeReport;
end
...
%--------------------------------------------------------------------------
function classificationEnsemble = boosTreeGen(Y,X,~)
...
%--------------------------------------------------------------------------
function y_hat = boosTreeApply(X,clasfier,~)
...
%--------------------------------------------------------------------------
function boosTreeReport(clasfier,~)
try
